...
-- Canonical hardening migration for manual signup approval RPCs.
-- This supersedes earlier grant rules from:
-- - 20260425211000_manual_signup_approval_rpcs.sql
-- - 20260425214000_one_query_manual_approve.sql
-- - 20260425222000_fix_one_query_approve_auth_shape.sql
-- - 20260425233500_fix_identities_email_generated.sql
...
-- Approval and rejection are intentionally SQL-editor/admin-only operations.
-- Do not grant execute to anon/authenticated roles.
